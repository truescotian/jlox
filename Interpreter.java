...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
	...
	Interpreter() {
		// define a variable named "clock" which implementes
		// LoxCallable.
	...
	public Object visitCallExpr(Expr.Call expr) {
		...
		// evaluate the expression for the callee. This is typically
		// an identifier that looks up the function by its name, but it
		// could be anything.
		...
		// prevent ClassCastException by ensuring callee is a LoxCallable
	...
	private Object lookupVariable(Token name, Expr expr) {
		...
		// remember that globals are treated specially and don't
		// end up in the map. Hence the name locals.
	...
	// analogue to the evaluate() method we have for expressions.
	...
	void executeBlock(List<Stmt> statements, Environment environment) {
		...
		try {
			// to execute code within a given scope, update the interpreter's 
			// environment field, visit all of the statements, then restore
			// the previous value.
